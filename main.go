...
import (
	...
	"local.dev/myoperator/controllers"
...
func main() {
	...
	opts := zap.Options{
		Development: true,
		ZapOpts:     []gzap.Option{gzap.AddCaller()},
	}
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "a997de4c.local.dev",
	...
	if err = (&mygroupv1alpha1.MyResource{}).SetupWebhookWithManager(mgr); err != nil {
